...
/*
fz_print_text_page_xml: Output a page to a file in XML raw format.
*/
void fz_print_stext_page_as_xmlraw(fz_context *ctx, fz_output *out, fz_stext_page *page, int pagenum, int res, const char* version); //[CCS - pagenum

/*
fz_print_text_page_xmltext: Output a page to a file in XMLTEXT format.
*/
typedef void(*tAddRectlist)(void* data, int typeofrect, int left, int top, int right, int bottom);
void fz_print_stext_page_as_xmltext(fz_context *ctx, fz_output *out, fz_stext_page *page, int pagenum, int lang, const char* imgname, tAddRectlist AddRectList, void* addrectdata, const char* version);
