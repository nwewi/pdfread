...
enum
{
    ...
    FZ_CCS_SKIP_INVALID = 8192,
    FZ_CCS_SKIP_BKG_IMAGE = 16384, //to avoid taking into account full page (f.e. for AbbyRecognitionServer generated PDFs, or for docWOrks generated PDFS (full image plus hidden text), or mixed
};
...
fz_device *fz_new_tracebuf_device(fz_context *ctx, fz_output *out);
...
//[CCS - draws only the image objects
